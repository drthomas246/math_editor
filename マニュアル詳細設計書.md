...
11章程度を前提とするため、Worker、永続index、非同期初期化は使用しない。
...
2. manual型、マニフェスト、空でない11章のMarkdown骨格を追加する。
...
- 11章のMarkdown、メタデータ、固定slugが存在する。
