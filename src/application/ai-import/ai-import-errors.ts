...
const ERROR_MESSAGES: Record<AiImportErrorCode, string> = {
  ...
  SCHEMA_MISMATCH: "Skillとすうがく仕立てのSchemaが一致しません。互換性を確認してください。",
  DIRECT_IMPORT_TOO_LARGE: "WebMCPの上限は2 MiBです。検証済みJSONを通常のインポートから読み込んでください。",
  INVALID_JSON: "JSONを解析できませんでした。完成ファイルを修正してください。",
  INVALID_WORKSHEET_FILE: "すうがく仕立ての単一プリント形式に適合しません。内容を修正してください。",
  ...
  CONSENT_REQUIRED: "すうがく仕立てで、このページセッションのAI連携を許可してください。",
  ...
  IMPORT_FAILED: "プリントを保存できませんでした。すうがく仕立ての状態を確認してください。",
