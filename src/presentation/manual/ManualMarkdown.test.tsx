 ...
 * Markdownの内容と操作を、アクセシブルな画面要素として構成する。
 *
 ...
 * 「ManualMarkdown」に関するテスト条件と検証例をまとめる。
 */
function defineTestSuite2() {
    it("GFM表、タスクリスト、脚注を表示する", (/**
     * 「GFM表、タスクリスト、脚注を表示する」という仕様を操作結果から検証する。
     */
     ...
     * 「HTMLと危険URLを無効化し、外部リンクを安全な別タブにする」という仕様を操作結果から検証する。
     */
     ...
     * 「内部リンク、callout、欠落画像を表示する」という仕様を操作結果から検証する。
     */
