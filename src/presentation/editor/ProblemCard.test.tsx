...
function defineTestSuite1() {
    ...
    function runTestCase2() {
        ...
        const view = render(<ProblemCard worksheet={worksheet} problem={problem} index={0} displayNumber="1." selected selectedContentId={problem.contents[0]!.id} onSelect={onSelect} onSelectContent={onSelectContent} onCommit={vi.fn()} onMutate={vi.fn()} onAddImage={vi.fn()} onUpdateImage={vi.fn()} assetUrls={new Map()} onToast={vi.fn()}/>);
    ...
    function runTestCase3() {
        ...
        const view = render(<ProblemCard {...commonProps} selected selectedContentId={problem.contents[0]!.id}/>);
        ...
        view.rerender(<ProblemCard {...commonProps} selected selectedContentId={null}/>);
        expect(view.container.querySelectorAll(".ProseMirror")).toHaveLength(1);
        ...
        view.rerender(<ProblemCard {...commonProps} selected={false} selectedContentId={null}/>);
    ...
    function runTestCase4() {
        ...
        const view = render(<ProblemCard worksheet={worksheet} problem={problem} index={0} displayNumber="1." selected selectedContentId={box.id} onSelect={vi.fn()} onSelectContent={vi.fn()} onCommit={vi.fn()} onMutate={onMutate} onAddImage={vi.fn()} onUpdateImage={vi.fn()} assetUrls={new Map()} onToast={vi.fn()}/>);
    ...
    function runTestCase6() {
        ...
        const view = render(<ProblemCard worksheet={worksheet} problem={problem} index={0} displayNumber="1." selected selectedContentId={problem.contents[0]!.id} onSelect={vi.fn()} onSelectContent={vi.fn()} onCommit={onCommit} onMutate={vi.fn()} onAddImage={vi.fn()} onUpdateImage={vi.fn()} assetUrls={new Map()} onToast={vi.fn()}/>);
    ...
    function runTestCase7() {
        ...
        const view = render(<ProblemCard worksheet={worksheet} problem={problem} index={0} displayNumber="1." selected selectedContentId={problem.contents[0]!.id} onSelect={vi.fn()} onSelectContent={vi.fn()} onCommit={vi.fn()} onMutate={vi.fn()} onAddImage={vi.fn()} onUpdateImage={vi.fn()} assetUrls={new Map()} onToast={vi.fn()}/>);
    ...
    function runTestCase9() {
        ...
        const onCommit = vi.fn();
        const view = render(<ProblemCard worksheet={worksheet} problem={problem} index={0} displayNumber="1." selected selectedContentId={answerArea.id} onSelect={vi.fn()} onSelectContent={vi.fn()} onCommit={onCommit} onMutate={vi.fn()} onAddImage={vi.fn()} onUpdateImage={vi.fn()} assetUrls={new Map()} onToast={vi.fn()}/>);
    ...
    function runTestCase11() {
        ...
        const view = render(<ProblemCard {...commonProps} selectedContentId={problem.contents[0]!.id}/>);
        fireEvent.click(view.getByRole("button", { name: /教師用の解説/u }));
